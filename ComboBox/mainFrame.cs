...
namespace L25_ComboBox
{
    public partial class mainFrame : Form
    {
        ...
        private void btnSignUp_Click( object sender, EventArgs e )
        {
            ...
            string phoneNumber = $"({cbbZipCodes.Text}){txtPhoneNumber.Text}";
            MessageBox.Show( $"Your email is: {email}. Your phone number is: {phoneNumber}" );
        }

        private void mainFrame_Load( object sender, EventArgs e )
        {
            List<string> zipCodes = new List<string> { "+084", "+082", "+1" };
            //cbbZipCodes.Items.AddRange( zipCodes.ToArray() );
            cbbZipCodes.DataSource = zipCodes;
